...
namespace JogoDeMemoria
{
    ...
    public class RegraJogo
    {
        ...
        private PictureBox Box = new PictureBox() { Image = Image.FromFile(@"F:\C#\JogoDaMemoria\JogoDeMemoria\Resources\box.png") };
        ...
        {
            DirectoryInfo Dir = new DirectoryInfo(@"F:\C#\JogoDaMemoria\JogoDeMemoria\Resources\Figura");
